...
DHT_topic = "greenhouse/sensors/dht"
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Greenhouse DHT Emulator')        
    ...
    def update_data(self):
        ...
        temp = 22 + random.randrange(1, 150) / 10
        hum = 30 + random.randrange(1, 600) / 10
        ...
        print("Published DHT data:", current_data)
