...
relay_topic = "greenhouse/actuators/relay"
global ON
ON = False
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        self.ePushtbtn = QPushButton("RELAY OFF", self)
    ...
    def update_btn_state(self, text):
        ...
        if text == "ON":
            ...
            self.ePushtbtn.setText("RELAY ON")
            ON = True
            print("Relay state changed to ON")

        elif text == "OFF":
            self.ePushtbtn.setStyleSheet("background-color: gray")
            self.ePushtbtn.setText("RELAY OFF")
            ON = False
            print("Relay state changed to OFF")

        else:
            print("Unknown relay command:", text)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Greenhouse Relay Emulator')       
