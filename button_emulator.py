...
button_topic = 'greenhouse/control/button'
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        self.ePushtbtn = QPushButton("Manual Pump Button", self)
    ...
    def push_button_click(self):
        self.mc.publish_to(self.ePublisherTopic.text(), "PRESSED")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Greenhouse Button Emulator')       
